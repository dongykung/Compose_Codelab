...
private fun ReplyDetailsScreenTopBar(
    ...
    Row(
        ...
        IconButton(
            ...
            modifier = Modifier
                .padding(dimensionResource(id = R.dimen.detail_topbar_back_button_padding_horizontal))
...
private fun ActionButton(
    ...
    Box(modifier = modifier) {
        Button(
            ...
            modifier = Modifier
                .fillMaxWidth()
                .padding(dimensionResource(id = R.dimen.detail_action_button_padding_vertical)),
            colors = ButtonDefaults.buttonColors(
                containerColor =
                if (containIrreversibleAction) MaterialTheme.colorScheme.onErrorContainer
...
@Composable
fun ReplyTopBarPreview() {
    val viewModel: ReplyViewModel = viewModel()
    val replyUiState = viewModel.uiState.collectAsState().value
    Android_ComposeCamp_CodelabTheme {
        ReplyDetailsScreen(onBackPressed = { /*TODO*/ }, replyUiState = replyUiState, isFullScreen = false)
    }
}