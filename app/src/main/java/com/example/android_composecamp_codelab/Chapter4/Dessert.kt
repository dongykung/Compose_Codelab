...
import com.example.android_composecamp_codelab.Chapter4.data.DessertDatasource
...
class Dessert : ComponentActivity() {
...
@Composable
private fun DessertClickerApp(desserts: List<DessertData>) {
...
private fun DessertClickerScreen(
    ...
    Box(modifier = modifier) {
        Image(
            painter = painterResource(id = R.drawable.bakery_back), contentDescription = null,
        ...
        Column {
            Box(
                ...
                Image(painter = painterResource(id = dessertImageId), contentDescription = null,
                    modifier = Modifier
                        .width(dimensionResource(id = R.dimen.image_size2))
                        .height(dimensionResource(id = R.dimen.image_size2))
                        .align(Alignment.Center)
                        .clickable { onDessertClicked() }, contentScale = ContentScale.Crop)
            }
            TransactionInfo(
                revenue = revenu, dessertSold = dessertsSold,
...
@Composable
private fun DessertClickerAppBarPreview() {
    Android_ComposeCamp_CodelabTheme {
        Surface(
            modifier = Modifier
                .fillMaxSize()
