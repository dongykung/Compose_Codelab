...
@VisibleForTesting  //메서드가 공개되지만 테스트 목적으로만 공개된다고 사용자에게 표시된다
...
@Composable
//@StringRes 주석은 문자열 리소스를 사용하는 방법으로 유형 안정성을 갖추고 있다. 이는 전달할 정수가
//value/string.xml 파일의 문자열 리소스임을 나타낸다.
